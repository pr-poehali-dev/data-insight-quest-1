        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-4 md:space-y-8">
              <a
                href="mailto:info@schetchiki.ru"
              ...
              >
                ...
                <p className="text-base text-foreground transition-colors group-hover:text-foreground/70 md:text-2xl">+7 964 433 94 15</p>
              </a>
          ...
          <div className="flex flex-col justify-center">
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div
                ...
                style={{ transitionDelay: "500ms" }}
              >
                <label className="mb-1 block font-mono text-xs text-foreground/60 md:mb-2">Что нужно сделать?</label>
                <textarea
                  rows={3}
                  ...
                  required
                  className="w-full border-b border-foreground/30 bg-transparent py-1.5 text-sm text-foreground placeholder:text-foreground/40 focus:border-foreground/50 focus:outline-none md:py-2 md:text-base"
                  placeholder="Например: замена счётчика воды, нужна опломбировка..."
                />
              </div>
